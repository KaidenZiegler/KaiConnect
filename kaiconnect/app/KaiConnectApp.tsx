...
export function KaiConnectApp() {
  ...
  return <div className="app-shell">
    <aside className="sidebar">
      ...
      <div className="sidebar-goal"><div className="goal-icon"><Target size={18} /></div><div><small>Weekly goal</small><strong>4 of 5 items rescued</strong></div><div className="mini-progress"><span style={{ width: "80%" }} /></div></div>
    </aside>
